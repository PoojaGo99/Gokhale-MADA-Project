...
Three different machine learning models were used to distinguish severity on the bases of sex, age, and type of ICI.
...
The Random Forest model has an AUC of 0.806. Thus, this models is able to predict between serious and non-serious cases ~81% of the time.
