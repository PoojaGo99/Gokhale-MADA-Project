...
A list of common irAEs was used. This list is available in the supplementary material. This list was informed by common irAEs reported in various clinical trials  [@Galsky2020] [@Galsky2020] [@Bajorin2021] [@Powles2020]. Any reactions that had the same age, weight, FDA received date, country of occurrence, suspected active ingredient, and reported reaction were considered duplicates and were removed.
